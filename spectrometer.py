...
def take_picture(name, shutter):
    print("work: initialising camera")
    camera = picamera.PiCamera()
    try:
        print("work: allowing camera to warmup")
        camera.vflip = True
